...
dir_punts_mostreig <- "results/02_Loop_punts_HIC/Punts_mostrei_pval/"
#dir.create(dir_punts_mostreig)

dir_malla <- "results/02_Loop_punts_HIC/Malla_per_HIC_pval/"
...
log_file <- "results/02_Loop_punts_HIC/Log_punts_HIC_ruta4.txt"

files_df

ruta_4 <- c(15, 23, 29, 33, 37, 38, 39  )
