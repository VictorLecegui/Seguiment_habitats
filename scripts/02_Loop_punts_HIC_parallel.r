...
punts_mostrejats |>
 ...
 # Filtrar si hi ha punts duplicat punts_mostrejats
...
dir_punts_mostreig <- "results/02_Loop_punts_HIC/Punts_mostreig_parallel/"
#dir.create(dir_punts_mostreig)

dir_malla <- "results/02_Loop_punts_HIC/Malla_per_HIC_parallel/"
...
### MARK: Loop 2: Comprovar el nombre de punts 
...
log_file <- "results/02_Loop_punts_HIC/Log_punts_HIC_parallel_20260309.txt"

### Preparar el parallel per la part de les iteracions
plan(multisession, workers = 4)
options(future.globals.maxSize = 16 * 1024^3)

for(k in 15:nrow(files_df)) {
